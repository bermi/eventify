...
export function formatEventifyBench(result) {
  ...
  lines.push(`samples=${result.config.samples} warmup=${result.config.warmup} iters=${result.config.iters}`);
  lines.push("");
...
if (isCliEntry(typeof process !== "undefined" ? process.argv : null, "bench/bench.mjs")) {
