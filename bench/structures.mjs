...
export function formatStructuresBench(result) {
  ...
  lines.push(`samples=${result.config.samples} warmup=${result.config.warmup} iters=${result.config.iters} keys=${result.config.keys}`);
  lines.push("");
...
if (isCliEntry(typeof process !== "undefined" ? process.argv : null, "bench/structures.mjs")) {
